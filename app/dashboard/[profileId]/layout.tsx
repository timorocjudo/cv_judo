        ...
        <div className="flex justify-between items-center px-margin-mobile md:px-margin-desktop h-16 max-w-container-max mx-auto">
          ...
          <nav className="flex items-center gap-4">
            <Link
              ...
              className="flex items-center gap-1.5 text-sm font-medium text-on-surface-variant hover:text-primary hover:bg-surface-container px-3 py-2.5 rounded-lg transition-colors"
            >
